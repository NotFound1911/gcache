...
// $GOPATH/bin/mockgen -destination=mocks/mock_redis_cmdable.gen.go -package=mocks github.com/redis/go-redis/v9 Cmdable

var (
	errFailedToSetCache = errors.New("gcache: 写入 redis 失败")
)
